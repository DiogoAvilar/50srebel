	...
	function s() {
		$(".slider--prev, .slider--next").click(function () {
			...
			$(".slider").animate({
				...
				t.hasClass("slider--next") ? a - 1 > i && a - 1 > s && a - 1 > o ?
					(l.removeClass("slider--item-left").next().addClass("slider--item-left"),
						...
						h.removeClass("slider--item-right").next().addClass("slider--item-right")) : i === a - 1 ?
						...
						s === a - 1 ? (l.removeClass("slider--item-left").next().addClass("slider--item-left"),
							u.removeClass("slider--item-center").first().addClass("slider--item-center"),
							h.removeClass("slider--item-right").next().addClass("slider--item-right")) :
							(l.removeClass("slider--item-left").next().addClass("slider--item-left"),
								c.removeClass("slider--item-center").next().addClass("slider--item-center"),
								u.removeClass("slider--item-right").first().addClass("slider--item-right")) : 0 !== i && 0 !== s && 0 !== o ?
						(l.removeClass("slider--item-left").prev().addClass("slider--item-left"),
							...
							h.removeClass("slider--item-right").prev().addClass("slider--item-right")) : 0 === i ?
							(u.removeClass("slider--item-left").last().addClass("slider--item-left"),
								c.removeClass("slider--item-center").prev().addClass("slider--item-center"),
								h.removeClass("slider--item-right").prev().addClass("slider--item-right")) : 0 === s ?
								(l.removeClass("slider--item-left").prev().addClass("slider--item-left"),
...
function play(numero) {
	if (status == "true") {
		document.getElementById("musica" + numero).play();
		document.getElementById("botao" + numero).style.backgroundImage = "url('assets/img/pause-branco.png')";
		status = "false";
	} else {
		document.getElementById("musica" + numero).pause();
		document.getElementById("botao" + numero).style.backgroundImage = "url('assets/img/play-branco.png')";
		status = "true";
	}
}

function historia() {
	texto = "<a href='bootstrap.html'><img src='assets/img/Botoes/voltar.png' class='img-botao-js'></a>"
	texto += "<div class='projeto'><video class='video' controls><source src='assets/img/7-rings.mp4' type='video/mp4'></video> </div>";
	document.getElementById("intro--banner").innerHTML = texto;
}
function cinquenta() {
	texto = "<a href='bootstrap.html'><img src='assets/img/Botoes/voltar.png' class='img-botao-js'></a>"
	texto += "<div class='projeto'><video class='video' controls><source src='assets/img/7-rings.mp4' type='video/mp4'></video> </div>";
...
function projeto() {
	texto = "<a href='bootstrap.html'><img src='assets/img/Botoes/voltar.png' class='img-botao-js'></a>";
	texto += "<div class='projeto'> <img src='assets/img/sobre.png' > </div>";
	document.getElementById("intro--banner").innerHTML = texto;
}

function sumir() {
	document.getElementById("albunsdentro").style.display = "none";
	document.getElementById("artistas-slider").style.display = "flex";
}

function voltar() {
	document.getElementById("albunsdentro").style.display = "flex";
}

function sumirArtistas() {
	document.getElementById("artistas-slider").style.display = "none";
	document.getElementById("albunsdentro").style.display = "flex";
}

function voltarArtistas() {
	document.getElementById("artistas-slider").style.display = "flex";
}

function irArtista() {
	document.getElementById("artistas-slider").style.display = "none";
	document.getElementsByClassName("totalplay")[0].style.display = "block";
}
